...
### System Diagnostics & Hardware Detection

![System Diagnostics](proc.jpg)

*Real-time hardware enumeration: CPU topology detection (6C/12T), 48MP USB camera initialization, and OpenVINO execution provider configuration.*

### Inference Performance Metrics

![Performance Timings](infer.jpg)

*Live inference pipeline timing breakdown: ~5-6ms preprocessing, ~26ms main tensor inference (640x640), ~5-7ms ROI refinement tracking (256x256). Sustained 120-180 FPS on standard Intel i5-11400 CPU.*

### Live Operation Demo

https://github.com/user-attachments/assets/recording_2026-06-29_10-30-34.mp4

*Real-time defect detection and oriented bounding box tracking on high-velocity conveyor simulation.*
...
6. The engine will instantly mount the incoming stream and spin up the live inference pipeline. All runtime parameters can be hot-tuned without recompilation via settings.json.
...
**COMMERCIAL & PRODUCTION PROHIBITION:** Commercial deployment, integration into active factory manufacturing processes, assembly line quality loops, or connection to any Industrial Automation Hardware (PLCs, Modbus/TCP relays, pneumatic actuators, sorting gates) without an explicit, prior written Commercial License Agreement signed by the author is strictly prohibited.
...
**📧 Business Inquiries:** To request commercial licensing terms, obtain production deployment builds, or initiate custom dataset model development, please contact via GitHub Developer Profile or open a technical Inquiry Issue.
